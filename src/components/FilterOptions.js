...
class FilterOptions extends React.Component {
  ...
  render() {
    ...
    let handleCusine = async (e) => {
      let copy = [];
      if (e.target.checked) {
        copy = [...cusine, e.target.value]
        console.log(copy);
        await filter.setState({ cusine: copy });
          ...
          <div className="options">
            ...
            <div className="optionsContainer">
              <div className="option">
                <input type="checkbox" value="North Indian" onChange={(e) => handleCusine(e)}/>
                <span className="option-text">North Indian</span>
              </div>
              <div className="option">
                <input type="checkbox" value="South Indian" onChange={(e) => handleCusine(e)}/>
                <span className="option-text">South Indian</span>
              </div>
              <div className="option">
                <input type="checkbox" value="Chinese" onChange={(e) => handleCusine(e)}/>
                <span className="option-text">Chinese</span>
              </div>
              <div className="option">
                <input type="checkbox" value="Fast Food" onChange={(e) => handleCusine(e)}/>
                <span className="option-text">Fast Food</span>
              </div>
              <div className="option">
                <input type="checkbox" value="Street Food" onChange={(e) => handleCusine(e)}/>
